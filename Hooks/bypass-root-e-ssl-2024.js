setTimeout(function () {
    Java.perform(function () {
        var VerifySecurityModule = Java.use("com.lgeha.nuts.security.module.VerifySecurityModule");

        var ROOTED_RESULT = Java.use("com.lgeha.nuts.security.module.VerifySecurityModule$ROOTED_RESULT");

        VerifySecurityModule.verifyCheck.implementation = function (rootedPredicate) {
            rootedPredicate.result(ROOTED_RESULT.NOT_ROOTED.value);
            console.log("Security check bypassed, reporting NOT_ROOTED.");
        };
    });
}, 0);
